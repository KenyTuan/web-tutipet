...
public class VnPayConstants {
    ...
    public static final String VNP_RETURN_URL = "http://localhost:3000/valid_payment";
    public static final String VNP_TMN_CODE = "BP7BWCCH";
    public static final String SECRET_KEY = "ORMZIIWFDLLMKFEKHLKAPRRTCDZGEMIX";
